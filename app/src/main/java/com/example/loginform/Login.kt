    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loginClick.setOnClickListener {
            ...
            if(ema.trim().length == 0){
                Toast.makeText(applicationContext,"Email field canot be empty!",Toast.LENGTH_SHORT).show()
            }
            if(pwd.trim().length == 0){
                Toast.makeText(applicationContext,"Password field canot be empty!",Toast.LENGTH_SHORT).show()
            }
            ...
            if(ema.equals("abc@xyz.com")&&(pwd.equals("123456"))){
                ...
                Toast.makeText(applicationContext,"Worng Email or Password!",Toast.LENGTH_SHORT).show()
